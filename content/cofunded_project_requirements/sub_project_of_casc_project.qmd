...
requirements. Products of a sub-project can be entered as described in [Product
Entry Guidance](../../product-entry-guidance/).

If the SA and CASC contributions cannot be teased apart into project and
sub-project, then follow the [co-funded
protocol](../collaborating-protocol.md)instead.
