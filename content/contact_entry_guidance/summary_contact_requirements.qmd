...
1.  [Main Tab](../project-entry-guidance/record-main-copy.md#point-of-contacts)
    / "Point of Contact” section
2.  [Main
    Tab](../project-entry-guidance/record-main-copy.md#responsible-parties-required)
    / Citation / “Responsible Parties” section
3.  [Metadata Tab](../project-entry-guidance/metadata-tab.md#metadata-contacts)
    / “Contacts” section
4.  [Funding Tab](../project-entry-guidance/funding-tab.md) / “Allocation”
    section. For Projects only.
5.  [Distribution Tab](../product-entry-guidance/distribution.md) / "Contacts”
...
{% hint style="info" %} Funding source should always identify the agency or
...
{% hint style="info" %} Funding administrator can also be used to differentiate
