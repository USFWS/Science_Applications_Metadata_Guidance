---
title: "Associating Records: Project"
editor: 
  markdown: 
    wrap: 80
---
...
{% hint style="info" %} Important: It is recommended you ALWAYS specify the
...
**Step 1**: Select "**product"** from the **Association Type** drop-down menu.
...
**Step 3**: Choose the product that you would like to associate from the
