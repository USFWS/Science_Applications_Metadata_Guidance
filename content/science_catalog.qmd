...
## MDEditor - SA Science Catalog Crosswalk

This table maps the elements in mdEditor to the equivalent elements 
in SA Science Catalog. Items will only show up in SA Science Catalog when they 
...
### Crosswalk Table
| Science Catalog      | Project            | Product            | 
|:---------------------|:-------------------|:-------------------|
...
^1^Items posted in the [USFWS Community](https://www.sciencebase.gov/catalog/item/5011a6bae4b0d78fd4e59bcd) 
are designated "FWS ScienceBase Community". 
Items in the [LCC Community](https://www.sciencebase.gov/catalog/item/4f4e476ee4b07f02db47e164) are designated
by which [Science Applications Region](https://www.sciencebase.gov/catalog/item/5b4e1c3fe4b06a6dd17df2d3) folder they reside.    
^2^For a Product item, the Fiscal Year is derived from the associated Project.  
