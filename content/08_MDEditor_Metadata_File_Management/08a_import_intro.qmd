...
"c_ookies and other site data\_" option will clear your mdEditor data).
...
that you back up your records before clearing the mdEditor cache to avoid losing
your data.** Consult the [Export](export.md) or Settings section of this manual
to learn more.
:::
...
[**Export**](export.md) and [**Import**](import/) functionality. The Export
functionality allows you to back up and share your records between browsers. The
Import functionality lets you load records into mdEditor, either from
previously-saved mdEditor session, exported from another browser, or downloaded
from ScienceBase.
...
project, products, and contacts together using the same scheme that your LCC
...
::: callout-warning
If contacts records are re-created, it results in another mdEditor identifier
...
backup your records. For more information, consult [Export](export.md).
...
of records. Consult the [Settings](../settings.md) section of this manual to
learn more.
