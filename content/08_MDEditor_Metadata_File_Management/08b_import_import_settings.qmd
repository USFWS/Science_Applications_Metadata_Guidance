...
::: callout-warning
Selecting "Replace" will remove all metadata records currently in mdEditor and
leave only the newly-imported files. If you are importing a record to add to the
existing records, choose "Merge."
:::
...
[mdJSON](08c_import_mdjson.qmd), 
[sbJSON](08d_import_sbjson.qmd), 
and 
[FGDC](08e_import_fgdc.qmd) metadata.
