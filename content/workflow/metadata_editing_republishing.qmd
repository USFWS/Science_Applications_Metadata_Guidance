...
## Step 3: [Import](../metadata_file_management/import_mdjson.qmd) mdEditor file(s).
...
## Step 5: Update [Contacts](../contact_records/contact_records_overview.qmd).

If you have new contacts to add to your metadata record, create those contacts.

## Step 6: Update [Projects](../project_records/project_records_overview.qmd).

Update/edit metadata as needed.

## Step 7: Update [Products](../product_records/product_records_overview.qmd).

Update/edit metadata as needed.

## Step 8: For applicable Products, create, import, or update Data [Dictionaries](../product_records/dictionaries_tab_product.qmd).
...
## Step 13: Consult with the different [QA/QC Resources](../trouble_shooting/qa_qc_resources.qmd).

See the [QA/QC Resources](../trouble_shooting/qa_qc_fixes.qmd) page for
