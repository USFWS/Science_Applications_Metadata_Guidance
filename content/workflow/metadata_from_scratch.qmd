...
## Step 4: Create [Contacts](../contact_records/contact_records_overview.qmd).

Contacts must be created or uploaded before they can be added to project and
product metadata records.

## Step 5: Create [Projects](../project_records/project_records_overview.qmd).
...
## Step 6: Create [Products](../product_records/product_records_overview.qmd).
...
## Step 7: For applicable Products, create Data [Dictionaries](../product_records/dictionaries_tab_product.qmd).
...
## Step 11: [Export](../metadata_file_management/export.qmd) 
