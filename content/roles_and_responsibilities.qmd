...
subtitle: "Science Applications Enterprise Roles and Responsibilities (Draft)"
editor: 
  markdown: 
    wrap: 80
---
...
-   Ensure data management responsibilities are followed when SA funds are
    allocated outside the Program (e.g., go to another FWS Program)
...
-   Sign memo stating a project intended for funding is not duplicative
    ...
    not need to go through any additional steps in the [Non-Duplication
    Policy](appendix/non_duplication_policy.qmd).
...
Representatives are the primary liaison with the contracting
...
awards or who are the primary liaison(s) with Office of Conservation Investment 
staff who issue financial assistance awards.
...
-   Ensure SA data management, Science Catalog, internal tracking, and
    ...
    -   Include requirement for a data management plan
...
also assumes the role of Project Officer.

-   Assumes role of SA Project Officer
-   Ensures deliverables are uploaded to ScienceBase
-   Writes and ensures project and product metadata meets SA standards
-   Works with Data Steward to develop a Data Management Plan
...
-   Assist non-SA Project Officers with ensuring SA data management, Science
    ...
    are followed.
-   Staff who publish metadata and/or data to ScienceBase must do so in 
    accordance with the requirements of the 
    [ScienceBase User Agreement](https://www.sciencebase.gov/catalog/userAgreement/show) 
    and comply with the Department of Interior privacy guidelines as describe 
    in the annual 
    [Information Management and Technology (IMT) Awareness](https://doitalent.ibc.doi.gov/course/view.php?id=14773) 
    training.
