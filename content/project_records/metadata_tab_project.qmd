...
|:------------------------------|:-------------|
| Metadata Status   | [**Required**](p#metadata-status-required)`r req_style`  |  
| Dates             | [**Required**](p#metadata-dates-required)`r req_style`   |
| Metadata Contacts |                                               |
|        Author     | [**Required**](p#metadata-contacts)`r req_style`         | 
|        Publisher  | [**Required**](p#metadata-contacts)`r req_style`         | 
|        Point of Contact | [**Required**](p#metadata-contacts)`r req_style`   | 
| Metadata Identifier     | [**Required**](p#metadata-identifier)`r req_style` | 
| Parent Metadata         | [**Required**](p#parent-metadata)`r req_style`     | 
| Metadata Repositories   | [**Required**](p#metadata-repositories)`r req_style` | 
