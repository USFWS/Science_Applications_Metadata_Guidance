...
:::{.callout-note}
To add contacts to a metadata record, you must first
create/upload the contacts in mdEditor. See the [Contacts](../contact_records/contact_records_overview.qmd) section
...
[Publish](../publishing/publishing_overview.qmd) section of this manual to learn more.
:::
