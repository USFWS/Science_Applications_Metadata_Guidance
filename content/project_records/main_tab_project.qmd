...
|:------------------------------|:-------------|
| Basic Information     |                                                                                                         |
|        Record ID      | [**Required**](main_tab_project.qmd#record-id-required)`r required_style`               |
|        Title          | [**Required**](main_tab_project.qmd#title-required)`r required_style`^\*^               |
|        Status         | [**Required**](main_tab_project.qmd#status-required)`r required_style`^\*^              |
| Default Locale        |                                                                                                         |
|        Language       | [**Required**](main_tab_project.qmd#default-locale-required)`r required_style`          | 
|        Character Set  | [**Required**](main_tab_project.qmd#default-locale-required)`r required_style`          | 
|        Country        | [**Required**](main_tab_project.qmd#default-locale-required)`r required_style`          | 
| Resource Type         | [**Required**](main_tab_project.qmd#resource-types)`r required_style`                   |
|        Point of Contact       | [**Required**](main_tab_project.qmd#point-of-contacts)`r required_style`        | 
|        Custodian              | [**Required**](main_tab_project.qmd#point-of-contacts)`r required_style`        | 
|        Administrator          | [**Required**](main_tab_project.qmd#point-of-contacts)`r required_style`^\*^    |
|        Administrative Region  | [**Required**](main_tab_project.qmd#point-of-contacts)`r required_style`        | 
|        Principal Investigator | [**Required, if applicable**](main_tab_project.qmd#point-of-contacts)`r req_if_app_style`^\*^ | 
|        Co-Principal Investigator | [If applicable]`r if_app_style`                                                              | 
| Citation                      |                                                                                                 |
|        Title                  | [**Required**](main_tab_project.qmd#title)`r required_style`^\*^                | 
|        Principal Investigator | [**Required**](main_tab_project.qmd#responsible-parties)`r required_style`^\*^  |
|        Online Resource Name   | [If applicable]`r if_app_style`                                                                 | 
|        Online Resource URL    | [If applicable]`r if_app_style`                                                                 | 
|        URL Function           | [If applicable]`r if_app_style`                                                                 | 
|        Metadata Identifier    | [**Required**](main_tab_project.qmd#responsible-parties)`r required_style`      |
|        Identifier Namespace   | [**Required**](main_tab_project.qmd#responsible-parties)`r required_style`      |
| Description                   |                                                                                                 | 
|        Abstract               | [**Required**](main_tab_project.qmd#abstract)`r required_style`^\*^             |
| Time Period                   |                                                                                                 |          
|        Start Date             | [**Required**](main_tab_project.qmd#time-period)`r required_style`^\*^          | 
|        End Date               | [**Required**](main_tab_project.qmd#time-period)`r required_style`^\*^          | 
...
## Point of Contacts [(Required)]`r required_style`
...
them here. 
<!-- 
Other optional identifiers for projects include: [Archive](../archiving.qmd) Folder Name.
-->
...
<!-- # This was the original way this was 
