...
| SA Priority Area                         | [**Required**]`r required_style`                |
| SA Science Topic                         | [**Required**]`r required_style`                |
| Conservation Action                      | [**Required, if applicable**]`r req_if_app_style` |
| Shared Priority                          | [If applicable]`r if_app_style` |
| Strategic Habitat Conservation Component | [If applicable]`r if_app_style` |
| Taxonomic Classification (ITIS)          | [If applicable]`r if_app_style` |
| Geographic Extent                        | [**Required, if applicable**]`r req_if_app_style` |
| Spatial Referenece and Resolution        | [**if applicable**]`r req_if_app_style` |
| GCMD Keywords                            | [Best practice]`r if_app_style`           |
| Shared Priority Keywords                 | [Best practice]`r if_app_style`           |
...
If your project already has a controlled vocab list in ScienceBase, unfortunately it
...
![Example ISO Topic Category Keywords](../../assets/example_keywords_entry.png)
