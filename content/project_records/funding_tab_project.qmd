...
| **Quick Reference: Project Funding Tab**  | Requirements     |
|:------------------------------------------|:--------------|
| **Award ID**                              | [**Required**]`r required_style`       |
| **Amount**                                | [**Required**]`r required_style`       |
| **Source**                                | [**Required**]`r required_style`       |
| **Funding Recipient Organization**        | [**Required**]`r required_style`       |
| **Funding Administrator**                 | [**Required**]`r required_style`       |
| **FWS sub-activity and funding codes**    | [Best Practice]`r if_app_style` |
| **Funding agreement type**                | [Best Practice]`r if_app_style` |
| **Matching Funds**, including above       | [Best Practice]`r if_app_style` |
| Time Period: **Dates**                    | [**Required**]`r required_style`       |
...
### Recipient ([**Required**]`r required_style`)
...
### Other Contacts ([**Required**]`r required_style`)
...
### Marked Funding ([Best Practice]`r if_app_style`)
...
### FWS Sub-Activity, Funding Codes, Agreement Type ([Best Practice]`r if_app_style`)
...
### Matching and In-kind Funds ([Best Practice]`r if_app_style`)
