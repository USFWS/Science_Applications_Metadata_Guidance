...
From the mdEditor header menu, select **Import**. Then you can click or drag and drop an FGDC 
standard .XML file onto the **Import Data** button to import a local file.
