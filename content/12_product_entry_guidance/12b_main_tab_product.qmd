...
{% hint style="info" %} Products must have a specific resource type selected,
NOT just "product". {% endhint %}
...
contact from the list of contacts. See the [Contacts](../contacts/) section for
...
{% hint style="info" %} For items that will be sent to data.gov, only the first
in the list of Responsible Parties (#0) will appear. {% endhint %}
...
{% hint style="info" %} Important: The URLs to access and download products must
...
access the actual product from data.gov. {% endhint %}
...
![Example of Online resource and identifier metadata
entries](../.gitbook/assets/image%20%2829%29.png)

{% hint style="danger" %} Digital Object Identifier can be entered both as an
...
the prefix and suffix of the DOI are required (see figure above). {% endhint %}
...
GNLCC2010-11. {% endhint %}

{% hint style="info" %} If your item does not have a ScienceBase ID (SBID) yet,
...
{% hint style="info" %} If the product metadata was created by copying another
...
Records](../data-management/copy-records.md) section of this manual to learn how
to make a copy. {% endhint %}
...
{% hint style="info" %} Tip: Write your abstracts for projects in the present
