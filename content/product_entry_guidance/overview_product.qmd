...
1.  Import or create your product record (see [workflow](../content/workflow/workflow_overview.qmd)).
...
4.  Fill out metadata information for the following tabs:
    ...
    -   [Keywords Tab](keyword_tab_product.qmd)
    ...
    -   [Documents Tab](documents_tab_products.qmd)
