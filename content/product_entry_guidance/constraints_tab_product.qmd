...
{% hint style="info" %} If your product is licensed, let people know here.
Typically files used will be public domain, but not always. {% endhint %}
...
![Example legal constraint entry for U.S. Government Works open
license](../.gitbook/assets/image%20%2827%29.png)
...
{% hint style="info" %} Classification is the class of security (e.g., top
secret, public access). {% endhint %}
