...
1.  Select **parentProject** from the **Association Type** drop-down
...
![](../../assets/product_association_type.png){width=97% fig-align="right"}

2. Click the **Select a Record** button to select an associated
project. 
...
![](../../assets/product_association_choose_parent.png){width=97% fig-align="right"}

4.  Fill out the Linked Association Type with **product**.

![](../../assets/product_association_linked_record.png){width=97% fig-align="right"}
