...
|:------------------------------|:-------------|
| Distributor                                      |   [**Required**]`r required_style` |
...
### Contacts and Role [(Required)]`r required_style`

If anything is filled out in the distribution section, a contact must be added.
The appropriate role is "distributor."
...
## Transfer Options [(Required, if applicable)]`r req_if_app_style`
