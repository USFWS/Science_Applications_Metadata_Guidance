...
|        Responsible Parties    | |
|               pointOfContact  | [Required](#responsible-parties-required)`r req_style` |
...
A **pointOfContact** and **principalInvestigator** are required. 
The Principal Investigator is the primary data creator. It is best practice 
to include any data co-creators as a **coPrincipalInvestigator**. 
