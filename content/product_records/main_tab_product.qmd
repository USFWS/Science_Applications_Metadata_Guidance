...
| Quick Reference: Product Main Tab                           | Requirements |
|:------------------------------------------------------------|:----------|
...
| Citation: **Title**, **Date**, **Responsible Parties**, **Online Resource**, **Identifier** | [**Required**]`r required_style` |
...
| principalInvestigator | The Project PI                                 | [**Required, if applicable**]`r req_if_app_style` |
| custodian             | Data Custodian                                 | [**Required, if applicable**]`r req_if_app_style`  |
| administrator         | Data Trustee                                   | [**Required**]`r required_style`                |
| administrator         | FWS Region (legacy and DOI Unified)            | [**Required**]`r required_style`                |
...
| Role                    | Contact         | Required?     |
|:------------------------|:----------------|:--------------|
| principalInvestigator   | Data Creator    | [**Required**]`r required_style`  |
| coPrincipalInvestigator | Data Co-Creator | [Best Practice]`r required_style` |
: {.striped .hover .bordered .md .allborder}  
